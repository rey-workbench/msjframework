...
class MakeMSJModule extends Command
{
    ...
    protected function collectLayoutType(): void
    {
        ...
        $layouts = [
            ...
            'master' => 'Master (Bawaan MSJ Framework & Views Master dengan Detail/Tabs)',
            'transc' => 'Transaksi (Bawaan MSJ Framework & Views Transaksi Header-Detail)',
            'system' => 'System (Bawaan MSJ Framework & Views System Master-Detail)',
            'sublnk' => 'SubLink (Bawaan MSJ Framework & Views SubLink dengan Link)',
