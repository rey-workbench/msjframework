...
namespace MSJFramework\LaravelGenerator\Templates\Controllers\Layouts\System;

use Illuminate\Support\Str;

class SystemControllerTemplate
{
...
class SystemController extends Controller
{
    public function index($data)
    {
        ...
        if ($getdatawhere->where != '') {
            ...
            if ($data['dmenu'] == 'KOP402') {
                $data['table_detail_d'] = DB::table($data['tabel'])->where($wherekey_h)->orderBy('angsuran_ke', 'ASC')->get();
            } else {
    ...
    public function ajax($data)
    {
        ...
        if ($getdatawhere->where != '') {
            ...
            if ($data['dmenu'] == 'KOP402') {
                $data['table_detail_d_ajax'] = DB::table($data['tabel'])->where($wherekey_h)->orderBy('angsuran_ke', 'ASC')->get();
            } else {
